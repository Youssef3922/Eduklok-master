...
public class DocentDAO {
    ...
    public boolean addDocent(String username, String password) {
        ...
        String insertSql = "INSERT INTO Docent (Username, Password, FailedAttempts, AccountLocked, LockTime) VALUES (?, ?, 0, FALSE, NULL)";
    ...
    public String checkLogin(String username, String password) {
        String sql = "SELECT Password, FailedAttempts, AccountLocked, LockTime FROM Docent WHERE Username = ?";
        try (Connection conn = DatabaseConnector.connect();
            ...
            return "❌ Docent inloggen mislukt: " + e.getMessage();
        }
